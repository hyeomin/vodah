  ...
  return (
    <View className="flex-1">
      ...
      <View className="w-full flex justify-center items-center mt-[60px] mb-[40px] h-[205px]">
        <AppText fontFamily="Poppins" className="text-[30px] leading-[45px] text-black">moment</AppText>
      </View>
      {/* 소셜 로그인 버튼들 */}
      <View className="w-full flex flex-col items-center gap-[15px]">
        ...
        >
          <Image
            ...
            resizeMode="contain"
          />
          <AppText fontFamily="Pretendard-Bold" weight="bold" className="flex-1 text-center text-[14px] text-black">
            카카오로 시작하기
          </AppText>
        </Pressable>
        {/* 애플 */}
      ...
      <View className="w-full flex justify-center items-center py-[25px] bottom-0">
        <View className="absolute top-7 left-0 w-full h-[1px] bg-[#E0E0E0]" />
        <AppText fontFamily="Pretendard" className="top-7 text-[14px] text-black text-center">고객센터</AppText>
      </View>
    </View>
  );
} 