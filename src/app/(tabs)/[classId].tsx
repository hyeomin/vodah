...
export default function ClassDetails() {
    ...
    const yogaClass = id
        ? dummyYogaClasses.find((yogaClass) => yogaClass.id === id)
        : dummyYogaClasses[0];
    ...
    return (
        <ScrollView className="bg-background">
            {/* Header Image */}
            <View className="h-[230px] bg-gray-300 justify-between">
                <View className="back-button bg-white rounded-full w-[35px] h-[35px] m-[20px] items-center justify-center">
                ...
                <View className="bottom-of-image flex-row w-full justify-between items-center pl-[20px] py-[20px]">
                    <View className="key-tag-container bg-white rounded-[5px] p-[5px]">
                        <AppText className="text-[13px]">실외 · 초급</AppText>
                    </View>
                ...
                <View className="class-header gap-[20px]">
                    <View className="key-summary-container gap-[10px]">
                        ...
                        <View className="card-tags-container flex-row items-center gap-[7px] ">
                            {yogaClass.tagIds.map((tagId) => (
                                <View className="tag-container flex justify-center items-center p-[5px] gap-[10px] rounded-[5px] bg-primary">
                                    <AppText className="text-[13px] text-white">
                                        {tagId}
                                    </AppText>
                                </View>
            ...
            <View className="instructor-container gap-[20px] p-[25px] border-b border-tertiary">
                <View className="instructor-info-container gap-[20px]">
                    ...
                    <View className="instructor-info flex-row gap-[10px]">
                        <View className="instructor-image h-[60px] w-[60px] rounded-full bg-gray-300"></View>
                        <View className="instructor-info-container gap-[7px] flex-1">
                            <AppText
                                weight="semibold"
                            ...
                            <AppText
                                className="instructor-description text-[15px]"
                                numberOfLines={2}
                            >
                                {instructor.bio}
                            </AppText>
            ...
            <View className="address-container gap-[10px] p-[25px]">
                ...
                <AppText className="address text-[13px] px-[5px]">
                    성남시 분당구 성남대로 393 두산위브 파빌리온 주소가 길어지면
                    다음 줄로 넘어갑니다.
                </AppText>
            </View>
